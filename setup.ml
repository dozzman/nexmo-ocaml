...
(* OASIS_START *)
(* DO NOT EDIT (digest: 94ece1b0322147ba5438c58c9d59c828) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Dorian Peake"];
          homepage = None;
          synopsis = "Nexmo SMS Messaging SDK for OCaml";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Credentials"; "Api"; "Sms"];
                      lib_pack = true;
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\162]\002\r\181\178\164\209\217'g\177z\226\192\014";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
